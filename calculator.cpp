...
setStyleSheet("QPushButton{  display: inline-block;background-color: #000000;border-radius: 10px;border: 4px double #cccccc;color: #eeeeee;text-align: center;padding: 10px;width: 10px;transition: all 0.5s;cursor: pointer;margin: 5px;}");
